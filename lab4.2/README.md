...
- **Distribution is the second half.** Training a LoRA is half the work; making it usable for someone else (uploading the adapter, providing trigger words, packaging it into a ComfyUI custom node) is the other half. That's lab 4.3.
